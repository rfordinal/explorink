...
class MapSerialConsole {
 public:
  ...
  // Non-const so MapActivity can push zoom info and post-reset stats
  // (setZoomInfo/setRenderStats/setTileRange) after every viewport reset.
  MapConsoleState& state() { return console_.state(); }
