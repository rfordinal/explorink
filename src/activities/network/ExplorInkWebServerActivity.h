...
#include "network/ExplorInkWebServer.h"
...
/**
 * ExplorInkWebServerActivity is the entry point for file transfer functionality.
 * It:
 ...
 * - Starts the ExplorInkWebServer when connected
 * - Handles client requests in its loop() function
 * - Cleans up the server and shuts down WiFi on exit
 */
class ExplorInkWebServerActivity final : public Activity {
  ...
  std::unique_ptr<ExplorInkWebServer> webServer;
 ...
 public:
  explicit ExplorInkWebServerActivity(GfxRenderer& renderer, MappedInputManager& mappedInput)
      : Activity("ExplorInkWebServer", renderer, mappedInput) {}
